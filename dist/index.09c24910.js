...
const validateEmail = (email)=>{
    const emailRegex = /^[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\.(com|org|net|mil|edu|biz|gov|info|name|museum|[a-zA-Z]{2})$/;
...
const darkMode = function() {
    if (darkModeToggle.checked === true) root.classList.add("dark-mode");
